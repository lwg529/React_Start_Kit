  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@asset': path.resolve(paths.appSrc, 'asset'),
        '@component': path.resolve(paths.appSrc, 'component'),
        '@constant': path.resolve(paths.appSrc, 'constant'),
        '@module': path.resolve(paths.appSrc, 'module'),
        '@page': path.resolve(paths.appSrc, 'page'),
        '@widget': path.resolve(paths.appSrc, 'widget'),
